...
// Also after typing the rendered field value doesn't update & format until the user clicks themselves "out" of the field. Pressing "Enter" would be a nice option also.

export default function PercentageInput({ fieldLabel, stateId }) {
  ...
  useEffect(() => {
    ...
    const loadSlice = async () => {
      try {
        ...
        setSliceAction(() => module.setInput); // NOTE!! This modular number input field only works with a state action named "setInput"
      } catch (error) {
