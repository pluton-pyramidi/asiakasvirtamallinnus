...
/* InputInteger needs props from the parent to 1) give the text field labels and 2) the name of state & its reducer to be used by the state reducer factory in store.js. The state and its reducer need to be configured in store.js */
